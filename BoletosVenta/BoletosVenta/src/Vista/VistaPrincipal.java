...
public class VistaPrincipal extends javax.swing.JFrame {
    ...
    DinamicList<Pasajero> listaCompradores = new DinamicList<>();
    ...
    private void Guardar() throws EmptyList, ParseException {
        ...
        if (cbxGenero.getSelectedIndex() == -1) {
            ...
            Integer IdPersona = listaCompradores.getLegth() + 1;
        ...
        if (cbxGenero.getSelectedIndex() == -1) {
            ...
            try {
                ...
                if (FechaSalidaBoletoV.before(fechaActual)) {
                    ...
                    listaCompradores.Agregar(PasajeroGuardar);
                    Guardar();
                }
